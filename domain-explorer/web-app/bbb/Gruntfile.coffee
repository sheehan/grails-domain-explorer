...
module.exports = (grunt) ->
  ...
  # https://github.com/cowboy/grunt/blob/master/docs/task_lint.md
    ...
    less:
      development:
        files: grunt.file.expandMapping(["app/styles/**/*.less"], "dist/debug/",
      ...
      compile:
        options:
          ...
          processName: (filename) ->
            new RegExp("^app/templates/(.*)\\.hbs").exec(filename)[1]
    ...
    copy:
      compile:
        files: grunt.file.expandMapping(["app/**/*.js", "vendor/**/*.js", "vendor/bootstrap/css/*.css", "vendor/bootstrap/img/*.png"], "dist/debug/", {})
