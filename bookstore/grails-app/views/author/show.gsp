	...
	<body>
		...
		<div id="show-author" class="content scaffold-show" role="main">
			...
			<ol class="property-list author">
				...
				<g:if test="${authorInstance?.middleInitial}">
				<li class="fieldcontain">
					<span id="middleInitial-label" class="property-label"><g:message code="author.middleInitial.label" default="Middle Initial" /></span>
					
						<span class="property-value" aria-labelledby="middleInitial-label"><g:fieldValue bean="${authorInstance}" field="middleInitial"/></span>
				...
				<g:if test="${authorInstance?.gender}">
				<li class="fieldcontain">
					<span id="gender-label" class="property-label"><g:message code="author.gender.label" default="Gender" /></span>
					
						<span class="property-value" aria-labelledby="gender-label"><g:fieldValue bean="${authorInstance}" field="gender"/></span>
				...
				<li class="fieldcontain">
					<span id="address-label" class="property-label"><g:message code="author.address.label" default="Address" /></span>
						...
						<span class="property-value" aria-labelledby="address-label"><g:link controller="address" action="show" id="${authorInstance?.address?.id}">${authorInstance?.address?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${authorInstance?.dateOfBirth}">
				<li class="fieldcontain">
					<span id="dateOfBirth-label" class="property-label"><g:message code="author.dateOfBirth.label" default="Date Of Birth" /></span>
					
						<span class="property-value" aria-labelledby="dateOfBirth-label"><g:formatDate date="${authorInstance?.dateOfBirth}" /></span>
